% libneatvnc(SECTION) | User Commands
%
% "October 11 2021"
...
libneatvnc - program to do something

# SYNOPSIS

**libneatvnc** **-e** _this_ [**\-\-example=that**] [{**-e** | **\-\-example**} _this_]
                 [{**-e** | **\-\-example**} {_this_ | _that_}]

**libneatvnc** [{**-h** | *\-\-help**} | {**-v** | **\-\-version**}]

# DESCRIPTION

This manual page documents briefly the **libneatvnc** and **bar** commands.

This manual page was written for the Debian distribution because the
original program does not have a manual page. Instead, it has documentation
in the GNU info(1) format; see below.

**libneatvnc** is a program that...
...
:   The system-wide configuration file to control the behaviour of
    libneatvnc. See **foo.conf**(5) for further details.
...
**libneatvnc** provides some return codes, that can be used in scripts:
