...
static uint32_t* damage_tile_hash_ptr(struct damage_refinery* self, uint32_t tx,
                                      uint32_t ty) {
...
static void damage_refine_tile(struct damage_refinery* self,
                               struct pixman_region16* refined, uint32_t tx,
                               uint32_t ty, const struct nvnc_fb* buffer) {
...
void damage_refine(struct damage_refinery* self,
                   ...
                   struct pixman_region16* hint, struct nvnc_fb* buffer) {
  ...
  int n_rects = 0;
  struct pixman_box16* rects = pixman_region_rectangles(&tile_region, &n_rects);
