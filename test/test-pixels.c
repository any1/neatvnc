...
static bool test_convert_pixels_4bpp(void)
{
	...
	nvnc_convert_pixels((uint8_t*)&dst, &dstfmt, src_addr, &srcfmt, 1);
...
static bool test_convert_pixels_3bpp(void)
{
...
int main()
{
	bool ok = test_convert_pixels_4bpp() &&
		test_convert_pixels_3bpp() &&
